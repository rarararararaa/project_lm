...
<head>
<meta charset="UTF-8">
<title><tiles:getAsString name="myPageTitle"/></title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/bookstoreStyle.css">
 <!-- lib css 추가 -->
<!-- <link rel="stylesheet" href="${pageContext.request.contextPath}/css/bookstoreStyle.css"> -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/lm/myPage.css">
</head>
<body>
	...
	<c:if test="${lo == 1}">
		...
		<tiles:insertAttribute name="gradeInfo"/>
