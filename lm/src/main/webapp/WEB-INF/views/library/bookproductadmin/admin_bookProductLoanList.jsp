...
<div class="page-main">
	...
	<form action="admin_bookloanlist.do" id="search_form" method="get">
		<ul class="search">
			...
			<li>
				...
				<input type="button" value="대출목록" 
				   onclick="location.href='admin_bookloanlist.do'">
			</li>
		</ul>
	</form>
	<c:if test="${count == 0}">
	<div class="result-display">대출중인 도서정보가 없습니다.</div>
	</c:if>
	<c:if test="${count > 0}">
	<table class="striped-table">
		...
		<tr class="align-center">
			...
			<td>
				<a href="admin_bookupdate.do?callNumber=${bookProduct.callNumber}">${bookProduct.lib_product_bookName}</a>
			</td>
			<td>
