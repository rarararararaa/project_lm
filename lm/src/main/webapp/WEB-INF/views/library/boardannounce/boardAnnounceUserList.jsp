...
<div class="page-main">
	<div class="box">
		...
		<div class="content-box-U">
			<form action="Userlist.do" id="search_form" method="get">
				<div class="button-box">
					<ul class="main-content">
						...
						<li><input class="small-button" type="submit" value="찾기">
							...
							onclick="location.href='Userlist.do'"> <c:if
								test="${mem_auth == 9}">
								<input class="small-button-B" type="button" value="(관리자)글쓰기"
								...
								<script type="text/javascript">
									$(function() {
										$('#order')
												.change(
														function() {
															location.href = 'Userlist.do?keyfield='
																	+ $(
																			'#keyfield')
																			.val()
																	+ '&keyword='
					...
					<c:forEach var="board_announce" items="${list}">
						<tr class="align-center">
							...
							<td class="row-title"><a
								href="detailUser.do?notice_num=${board_announce.notice_num}">${board_announce.notice_title}</a>
							</td>
							<td class="row-title">
								<div class="answer">
									<b>관리자</b>
